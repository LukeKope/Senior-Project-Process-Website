  ...
  return (
    <div className="weekContentWrapper">
      <div className="content">
        ...
        <p>
          The focus of this week was to really finalize the designs and get them
          to a place where I can start coding a basic MVP. I shifted to more
          basic sketched out wireframes, really focusing on what each page
          needed and what its purpose was. After that, I shifted back to more
          high fidelity wireframes, finalizing the pace page, playlist creation
        ...
        <h3>Wireframes</h3>
        <p>
          Screenshots coming soon... I have them on my iPad and just need to
          transfer them to my PC
        </p>
